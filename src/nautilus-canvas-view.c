...
nautilus_canvas_view_supports_manual_layout (NautilusCanvasView *view)
{
	...
	return !nautilus_canvas_view_is_compact (view);
}
...
set_labels_beside_icons (NautilusCanvasView *canvas_view)
{
	...
	if (nautilus_canvas_view_supports_labels_beside_icons (canvas_view)) {
		labels_beside = nautilus_canvas_view_is_compact (canvas_view) ||
...
static void
set_columns_same_width (NautilusCanvasView *canvas_view)
{
	gboolean all_columns_same_width;

	if (nautilus_canvas_view_is_compact (canvas_view)) {
		...
		nautilus_canvas_container_set_all_columns_same_width (get_canvas_container (canvas_view), all_columns_same_width);
	}
}
...
static gboolean
nautilus_canvas_view_scroll_event (GtkWidget *widget,
...
{
	if (nautilus_canvas_view_is_compact (NAUTILUS_CANVAS_VIEW (view))) {
			   ...
			   GParamSpec      *pspec)
{
	...
	case PROP_COMPACT:
		...
		if (canvas_view->details->compact) {
			...
			nautilus_canvas_container_set_forced_canvas_size (get_canvas_container (canvas_view),
...
nautilus_canvas_view_class_init (NautilusCanvasViewClass *klass)
{
	...
	GTK_WIDGET_CLASS (klass)->scroll_event = nautilus_canvas_view_scroll_event;
...
gboolean
nautilus_canvas_view_is_compact (NautilusCanvasView *view)
{
...
void
nautilus_canvas_view_compact_register (void)
{
