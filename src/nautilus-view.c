...
get_directory_view_of_extra_pane (NautilusView *view)
{
	...
	slot = nautilus_window_get_extra_slot (nautilus_view_get_window (view));
	if (slot != NULL) {
...
static const GtkActionEntry directory_view_entries[] = {
  ...
  /* name, stock id, label */  { NAUTILUS_ACTION_COPY_TO, NULL, N_("Cop_y to") },
  /* name, stock id, label */  { NAUTILUS_ACTION_MOVE_TO, NULL, N_("M_ove to") },                      
 ...
 /* tooltip */                   N_("Redo the last undone action"),
  ...
  /* name, stock id, label */  {NAUTILUS_ACTION_COPY_TO_DESKTOP, NULL,
				N_("_Desktop"), NULL,
				N_("Copy the current selection to the desktop"),
				G_CALLBACK (action_copy_to_desktop_callback) },
  /* name, stock id, label */  {NAUTILUS_ACTION_MOVE_TO_DESKTOP, NULL,
				N_("_Desktop"), NULL,
