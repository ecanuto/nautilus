...
void		  nautilus_canvas_container_set_forced_canvas_size        (NautilusCanvasContainer  *container,
									   int                     forced_icon_size);
void		  nautilus_canvas_container_set_all_columns_same_width    (NautilusCanvasContainer  *container,
